...
class GetByIdTwitesUsecase extends Usecase<TwitModel, String> {
  HomeRepostiories homeRepostiories;
  GetByIdTwitesUsecase({
    required this.homeRepostiories,
  });
  @override
  Future<Either<Failure, TwitModel>> call(String params) {
    return homeRepostiories.getByIdTwites(params);
  }
}
